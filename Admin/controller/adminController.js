...
const {nameRegex, phoneRegex, emailRegex, passRegex } = require('../../validations/validation');
...
const update_admin = async function (req, res) {
  try {
    ...
    let { name, number, email, password, address, profielImage } = data;
    ...
    let obj = {
      ...
      profileImage : profielImage ? profileImage : admin.profileImage
    };
    if(req.files){
      obj['profileImage'] = {
